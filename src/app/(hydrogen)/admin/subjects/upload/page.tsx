...
export default function AdminSubjectUploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Đã tải lên và phê duyệt tài liệu!');
  ...
  return (
    <div className="min-h-screen bg-paper">
      <div className="arionear-container py-10 md:py-16">
        ...
        <h1 className="page-heading mb-2">Tải lên tài liệu môn học</h1>
        <p className="subheading mb-12">Tải lên tài liệu đã duyệt vào các môn học.</p>
            ...
            {selectedSubject ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" disabled={submitting} className="btn-primary w-full">
                  {submitting ? 'Đang tải lên...' : 'Tải lên & Phê duyệt'}
                </button>
              </form>
            ) : (
